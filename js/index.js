	  ...
	  entries.forEach(entry => {
		if (entry.isIntersecting) {
			...
			if (module == 0 && !isHobbyLoad) {
				...
				setProgress(66, document.getElementById("proagress3"), document.getElementById("proagress-text3"));
				setProgress(37, document.getElementById("proagress4"), document.getElementById("proagress-text4"));
...
function p1() {
	setProgress(11, document.getElementById("proagress1"), document.getElementById("proagress-text1"));
}
...
function p3() {
	setProgress(65, document.getElementById("proagress3"), document.getElementById("proagress-text3"));
}

function p4() {
	setProgress(35, document.getElementById("proagress4"), document.getElementById("proagress-text4"));
}
