...
window.onload = function() {
	...
	const backHeight = element.offsetHeight;
	
	const tableSpace = document.getElementById("table-space");
	const tableHeight = tableSpace.offsetHeight;
	
	const top1 = document.getElementById("top1");
	const top1Height = top1.offsetHeight;
	
	const top2 = document.getElementById("top2");
	top2.style.marginTop = backHeight - top1Height - 60 - tableHeight + "px";
...
function start() {
	viewState(document.getElementById("view1"), document.getElementById("developer-load"), 0);
	viewState(document.getElementById("view2"), document.getElementById("hobby-data"), 1);
	viewState(document.getElementById("view3"), document.getElementById("java-project"), 2);
	viewState(document.getElementById("view4"), document.getElementById("c-project"), 3);
	viewState(document.getElementById("view5"), document.getElementById("php-project"), 4);
	viewState(document.getElementById("view6"), document.getElementById("html-project"), 5);
	viewState(document.getElementById("view7"), document.getElementById("ue-project"), 6);
	viewState(document.getElementById("view8"), document.getElementById("kotlin-project"), 7);
	viewState(document.getElementById("view9"), document.getElementById("experienced-space"), 8);
}
...
document.addEventListener('DOMContentLoaded', async function () {
  ...
  try {
    ...
    contentEl.innerText = '没有SSL有啥办法呢？点开吧777，来吧，你好呀？！11111111111111111111111111111111111111111111111';
  }
});
